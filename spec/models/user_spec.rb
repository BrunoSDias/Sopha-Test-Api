    ...
    describe 'scopes' do
        ...
        describe 'order_user_by_name' do
            it 'retorna usuários ordenados por nome' do
                user1 = User.create name: "Javier", email: Faker::Internet.email, password: "password999", password_confirmation: "password999"
                user2 = User.create name: "Allan", email: Faker::Internet.email, password: "password777", password_confirmation: "password777"
