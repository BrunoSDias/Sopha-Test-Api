...
RSpec.describe Store, type: :model do
    subject { User.new(name: 'Jonathan', email: 'jonathan@gmail.com', password: 'johnversionx1') }
    ...
    describe 'scopes' do
        context '.search_store' do
            it 'verifica se tem algum catalogo com o nome vindo por params' do
                user = User.create(name: 'Jonathan', email: 'jonathan@gmail.com', password:'johnversionx1')
